...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'FCM device token from the client' }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)(),
    __metadata("design:type", String)
], RegisterDeviceDto.prototype, "token", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Device identifier for upsert (e.g. Android ID)' }),
...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'FCM device token to remove' }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)(),
    __metadata("design:type", String)
