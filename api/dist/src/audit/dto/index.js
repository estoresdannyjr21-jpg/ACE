...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Filter by entity type (e.g. TRIP, OPERATOR)' }),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Filter by action (CREATE, UPDATE, DELETE, VIEW)' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
